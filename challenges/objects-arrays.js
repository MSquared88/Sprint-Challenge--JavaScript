...
const contactInfo = graduates.map((arr)=>{
...
const lowerCase = zooAnimals.map((arr) =>{
...
*/
const lowerPopulation = zooAnimals.filter((arr) =>{
...
*/
const populationTotal = zooAnimals.reduce((sum,arr)=>{
